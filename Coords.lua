...
function stash_house_coords(location)
	if location == 0 then return vec3:new(-157.009, 6293.16, 32.183)
	elseif location == 1 then return vec3:new(-1102.0671, 4940.5005, 218.854)
	elseif location == 2 then return vec3:new(2257.658, 5165.4736, 59.617)
	elseif location == 3 then return vec3:new(2882.539, 4511.958, 48.505)
	elseif location == 4 then return vec3:new(1334.5059, 4306.1904, 38.826)
	elseif location == 5 then return vec3:new(1857.284, 3854.889, 33.589)
	elseif location == 6 then return vec3:new(906.301, 3585.9163, 34.05)
	elseif location == 7 then return vec3:new(2403.179, 3127.5933, 48.733)
	elseif location == 8 then return vec3:new(549.9503, 2656.7966, 42.842)
	elseif location == 9 then return vec3:new(-1099.4067, 2723.0322, 19.4)
	elseif location == 10 then return vec3:new(-126.707, 1896.97, 197.833)
	elseif location == 11 then return vec3:new(1547.021, 2166.854, 79.476)
	elseif location == 12 then return vec3:new(-3170.7556, 1033.8252, 21.345)
	elseif location == 13 then return vec3:new(121.2021, 319.7567, 112.651)
	elseif location == 14 then return vec3:new(-582.865, 196.08, 71.946)
	elseif location == 15 then return vec3:new(-1308.8209, -169.2133, 44.46)
	elseif location == 16 then return vec3:new(98.9951, -240.265, 51.899)
	elseif location == 17 then return vec3:new(1153.0669, -431.5856, 67.532)
	elseif location == 18 then return vec3:new(-546.595, -873.17, 27.699)
	elseif location == 19 then return vec3:new(-1292.6188, -1258.7826, 4.704)
	elseif location == 20 then return vec3:new(161.8677, -1307.8274, 29.775)
	elseif location == 21 then return vec3:new(979.4723, -1982.9292, 31.075)
	elseif location == 22 then return vec3:new(1125.2518, -1010.1687, 45.178)
	elseif location == 23 then return vec3:new(167.298, -2221.8318, 7.775)
	elseif location == 24 then return vec3:new(-559.3438, -1804.6897, 23.11)
	else return vec3:new(0.0, 0.0, 0.0)
	end
end
