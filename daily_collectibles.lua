...
local dead_drop_coords = {
    [0] = {
        vec3:new(1113.557, -645.957, 56.091),
        vec3:new(1142.874, -662.951, 57.135),
        vec3:new(1146.691, -703.717, 56.167),
        vec3:new(1073.542, -678.236, 56.583),
        vec3:new(1046.454, -722.915, 56.419)
    },
    [1] = {
        vec3:new(2064.713, 3489.88, 44.223),
        vec3:new(2081.859, 3553.254, 42.157),
        vec3:new(2014.72, 3551.499, 42.726),
        vec3:new(1997.019, 3507.838, 39.666),
        vec3:new(2045.597, 3564.346, 39.343)
    },
    [2] = {
        vec3:new(-1317.344, -1481.97, 3.923),
        vec3:new(-1350.041, -1478.273, 4.567),
        vec3:new(-1393.87, -1445.139, 3.437),
        vec3:new(-1367.034, -1413.992, 2.611),
        vec3:new(-1269.861, -1426.272, 3.556)
    },
    [3] = {
        vec3:new(-295.468, 2787.385, 59.864),
        vec3:new(-284.69, 2848.234, 53.266),
        vec3:new(-329.193, 2803.404, 57.787),
        vec3:new(-306.847, 2825.6, 58.219),
        vec3:new(-336.046, 2829.988, 55.448)
    },
    [4] = {
        vec3:new(-1725.245, 233.946, 57.685),
        vec3:new(-1639.892, 225.521, 60.336),
        vec3:new(-1648.48, 212.049, 59.777),
        vec3:new(-1693.318, 156.665, 63.855),
        vec3:new(-1699.193, 179.574, 63.185)
    },
    [5] = {
        vec3:new(-949.714, -710.658, 19.604),
        vec3:new(-938.774, -781.817, 19.657),
        vec3:new(-884.91, -786.863, 15.043),
        vec3:new(-895.257, -729.943, 19.143),
        vec3:new(-932.986, -746.452, 19.008)
    },
    [6] = {
        vec3:new(-425.948, 1213.342, 324.936),
        vec3:new(-387.267, 1137.65, 321.704),
        vec3:new(-477.999, 1135.36, 320.123),
        vec3:new(-431.822, 1119.449, 325.964),
        vec3:new(-387.902, 1161.655, 324.529)
    },
    [7] = {
        vec3:new(-3381.278, 965.534, 7.426),
        vec3:new(-3427.724, 979.944, 7.526),
        vec3:new(-3413.606, 961.845, 11.038),
        vec3:new(-3419.585, 977.595, 11.167),
        vec3:new(-3425.687, 961.215, 7.536)
    },
    [8] = {
        vec3:new(-688.732, 5828.4, 16.696),
        vec3:new(-673.425, 5799.744, 16.467),
        vec3:new(-710.348, 5769.631, 16.75),
        vec3:new(-699.926, 5801.619, 16.504),
        vec3:new(-660.359, 5781.733, 18.774)
    },
    [9] = {
        vec3:new(38.717, 6264.173, 32.88),
        vec3:new(84.67, 6292.286, 30.731),
        vec3:new(97.17, 6288.558, 38.447),
        vec3:new(14.453, 6243.932, 35.445),
        vec3:new(67.52, 6261.744, 32.029)
    },
    [10] = {
        vec3:new(2954.598, 4671.458, 50.106),
        vec3:new(2911.146, 4637.608, 49.3),
        vec3:new(2945.212, 4624.044, 49.078),
        vec3:new(2941.139, 4617.117, 52.114),
        vec3:new(2895.884, 4686.396, 48.094)
    },
    [11] = {
        vec3:new(1332.319, 4271.446, 30.646),
        vec3:new(1353.332, 4387.911, 43.541),
        vec3:new(1337.892, 4321.563, 38.093),
        vec3:new(1386.603, 4366.511, 42.236),
        vec3:new(1303.193, 4313.509, 36.939)
    },
    [12] = {
        vec3:new(2720.03, 1572.762, 20.204),
        vec3:new(2663.161, 1581.395, 24.418),
        vec3:new(2661.482, 1641.057, 24.001),
        vec3:new(2671.003, 1561.394, 23.882),
        vec3:new(2660.104, 1606.54, 28.61)
    },
    [13] = {
        vec3:new(211.775, -934.269, 23.466),
        vec3:new(198.265, -884.039, 30.696),
        vec3:new(189.542, -919.726, 29.96),
        vec3:new(169.504, -934.841, 29.228),
        vec3:new(212.376, -934.807, 29.007)
    },
    [14] = {
        vec3:new(1330.113, -2520.754, 46.365),
        vec3:new(1328.954, -2538.302, 46.976),
        vec3:new(1237.506, -2572.335, 39.791),
        vec3:new(1244.602, -2563.721, 42.646),
        vec3:new(1278.421, -2565.117, 43.544)
    }
}
...
script.register_looped("Daily Collectibles", function()
    ...
    street_dealer_loc[0]        = globals.get_int(global_three + global_three_offset + 1 + (0 * 7))
    street_dealer_loc[1]        = globals.get_int(global_three + global_three_offset + 1 + (1 * 7))
    street_dealer_loc[2]        = globals.get_int(global_three + global_three_offset + 1 + (2 * 7))
